//
//  BodyTemperatureContainer.swift
//  HealthKitOnFhir
//
...
open class BodyTemperatureContainer : ResourceContainer<Observation>, HDSExternalObjectProtocol {
    ...
    public static func externalObject(object: HKObject, converter: HDSConverterProtocol?) -> HDSExternalObjectProtocol? {
        if let sample = object as? HKSample,
            sample.sampleType == BodyTemperatureContainer.healthKitObjectType() {
            return BodyTemperatureContainer(object: object, converter: converter)
        }
    ...
    public static func externalObject(deletedObject: HKDeletedObject, converter: HDSConverterProtocol?) -> HDSExternalObjectProtocol? {
        return BodyTemperatureContainer(deletedObject: deletedObject, converter: converter)
    }
