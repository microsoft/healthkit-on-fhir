//
//  AppleStandTimeContainerTests.swift
...
class AppleStandTimeContainerSpec: QuickSpec {
    override func spec() {
        ...
        describe("AppleStandTimeContainer") {
            itBehavesLike("external object protocol") { ["externalObjectType" : AppleStandTimeContainer.self,
                                                         "authorizationTypes" : [type],
                                                         "healthKitObjectType" : type,
                                                         "object" : object,
                                                         "incorrectObject" : incorrectObject]
            }
            itBehavesLike("resource container protocol") { ["externalObjectType" : AppleStandTimeContainer.self,
