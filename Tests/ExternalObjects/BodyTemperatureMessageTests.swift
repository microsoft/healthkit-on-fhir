//
//  BodyTemperatureMessageTests.swift
...
class BodyTemperatureMessageSpec: QuickSpec {
    override func spec() {
        ...
        describe("BodyTemperatureMessage") {
            itBehavesLike("external object protocol") { ["externalObjectType" : BodyTemperatureMessage.self,
                                                         "authorizationTypes" : [type],
                                                         "healthKitObjectType" : type,
                                                         "object" : object,
                                                         "incorrectObject" : incorrectObject]
            }
            itBehavesLike("event hubs message") { ["externalObjectType" : BodyTemperatureMessage.self,
                                                   "object" : object,
                                                   "json" : "{\"bodyTemperature\":37,\"endDate\":\"1970-01-01T00:00:00Z\",\"startDate\":\"1970-01-01T00:00:00Z\",\"unit\":\"degC\",\"uuid\":\"00000000-0000-0000-0000-000000000000\"}"]
            }
        }
    }
}
