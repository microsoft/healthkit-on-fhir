//
//  WalkingHeartRateAverageContainerTests.swift
...
class WalkingHeartRateAverageContainerSpec: QuickSpec {
    override func spec() {
        ...
        describe("WalkingHeartRateAverageContainer") {
            itBehavesLike("external object protocol") { ["externalObjectType" : WalkingHeartRateAverageContainer.self,
                                                         "authorizationTypes" : [type],
                                                         "healthKitObjectType" : type,
                                                         "object" : object,
                                                         "incorrectObject" : incorrectObject]
            }
            itBehavesLike("resource container protocol") { ["externalObjectType" : WalkingHeartRateAverageContainer.self,
