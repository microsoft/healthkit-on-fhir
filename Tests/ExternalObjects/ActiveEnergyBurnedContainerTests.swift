//
//  ActiveEnergyBurnedContainerTests.swift
...
class ActiveEnergyBurnedContainerSpec: QuickSpec {
    override func spec() {
        ...
        describe("ActiveEnergyBurnedContainer") {
            itBehavesLike("external object protocol") { ["externalObjectType" : ActiveEnergyBurnedContainer.self,
                                                         "authorizationTypes" : [type],
                                                         "healthKitObjectType" : type,
                                                         "object" : object,
                                                         "incorrectObject" : incorrectObject]
            }
            itBehavesLike("resource container protocol") { ["externalObjectType" : ActiveEnergyBurnedContainer.self,
